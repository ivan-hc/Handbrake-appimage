...
SHARESAVED="gst locale" # Enter here keywords or file/folder names to save in both /usr/share and /usr/lib
LIBSAVED="alsa jack pipewire pulse libab dvd" # Enter here keywords or file/folder names to save in /usr/lib
