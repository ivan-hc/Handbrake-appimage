...
rm -R -f ./$APP.AppDir/.junest/usr/bin/ccmake
...
rm -R -f ./$APP.AppDir/.junest/usr/bin/cmake*
...
rm -R -f ./$APP.AppDir/.junest/usr/bin/cpack
...
rm -R -f ./$APP.AppDir/.junest/usr/bin/ctest
